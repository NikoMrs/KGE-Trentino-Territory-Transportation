...
def bike_sharing_1():
    input_csv = "../../Phase 2 - Information Gathering/Datasets/raw datasets/bike_sharing.csv"
...
def bike_sharing_2():
    input_json = "../../Phase 2 - Information Gathering/Datasets/raw datasets/centro_in_bici.csv"
...
def scooter_sharing():
    input_csv = "../../Phase 2 - Information Gathering/Datasets/raw datasets/monopattini_agevolata.csv"
...
def taxi():
    input_csv = "../../Phase 2 - Information Gathering/Datasets/raw datasets/taxi.csv"
...
def car_sharing():
    input_csv = "../../Phase 2 - Information Gathering/Datasets/raw datasets/car_sharing.csv"
...
def parking_facility():
    input_json = "../../Phase 2 - Information Gathering/Datasets/raw datasets/parking.json"
...
def bike_rack_1():
    input_json = "../../Phase 2 - Information Gathering/Datasets/raw datasets/rastrelliere.csv"
...
def bike_rack_2():
    input_json = "../../Phase 2 - Information Gathering/Datasets/raw datasets/parcheggio_protetto_bike.csv"

...
def routes(folder):
    input_csv = f"../../Phase 2 - Information Gathering/Datasets/raw datasets/{folder}/routes.txt"
...
def stops(folder):
    input_csv = f"../../Phase 2 - Information Gathering/Datasets/raw datasets/{folder}/stops.txt"
...
def calendar(folder):
    input_csv = f"../../Phase 2 - Information Gathering/Datasets/raw datasets/{folder}/calendar.txt"
...
def special_schedule(folder):
    input_csv = f"../../Phase 2 - Information Gathering/Datasets/raw datasets/{folder}/calendar_dates.txt"
...
def trips(folder):
    input_csv = f"../../Phase 2 - Information Gathering/Datasets/raw datasets/{folder}/trips.txt"
...
def stop_times(folder):
    input_csv = f"../../Phase 2 - Information Gathering/Datasets/raw datasets/{folder}/stop_times.txt"
